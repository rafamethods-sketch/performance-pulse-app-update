...
export function Sidebar({ activeSheet, collapsed, onSheetChange, onToggleCollapsed, role }: SidebarProps) {
  ...
  return (
    <aside
      className={`hidden min-h-screen shrink-0 self-stretch overflow-y-auto border-r border-line bg-panel/85 py-6 transition-[width,padding] duration-200 ${role === "athlete" ? "xl:block" : "lg:block"} ${
